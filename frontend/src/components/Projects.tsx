    ...
    return (
      <div className="card">
        <h3 className="text-xl font-semibold">
          <a href={githubLink} className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
            {title}
          </a>
        </h3>
        ...
        <a href={githubLink} className="inline-block mt-4 text-primary hover:underline" target="_blank" rel="noopener noreferrer">
          View on GitHub
        </a>
      </div>
    );
