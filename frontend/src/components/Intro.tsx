...
const buildChatGPTPrompt = (siteUrl: string) =>
  [
    ...
    `These are live, public pages. Use your browsing and search tools to access them. If direct fetch fails, search "site:${new URL(siteUrl).hostname}" to find the content.`,
    ``,
