  ...
  "writings": [
    {
      ...
      "markdown": "# Lifelong Learning\n\nKnowledge is not a trophy room; it is a metabolism. The minute the appetite dulls, the organism begins confusing yesterday's map for tomorrow's terrain.\n\n- curiosity as immune system\n- study as competitive oxygen\n- ignorance as a debt instrument with compounding interest\n\nTo stop learning is to become locally impressive and globally obsolete. The world does not pause for your previous competence to finish applauding itself."
    },
    {
      "slug": "kinetic-agency",
      "order": 2,
      ...
      "markdown": "# Kinetic Agency\n\nRigidity is a luxury good purchased by people who have mistaken stillness for safety. The useful agent stays liquid: fast enough to exploit turbulence, skeptical enough to puncture consensus, disciplined enough to transmute ambiguity into motion.\n\nCritical thinking is not decorative skepticism. It is the engine that lets you update under pressure without becoming random.\n\n> agility is strategy before it hardens into doctrine."
    },
    {
      ...
      "markdown": "# Common Intelligence\n\nIntelligence is undergoing its electricity moment: first miracle, then commodity, then invisible substrate. The political question becomes brutally simple: who gets voltage, who gets darkness, and who profits from the rationing.\n\nIf cognition becomes abundant but access remains priestly, the future calcifies into a caste system with better interfaces.\n\n- intelligence as public utility\n- capability as emancipation\n- literacy after language itself learns to speak back"
    },
    {
      "slug": "taste",
      "order": 4,
