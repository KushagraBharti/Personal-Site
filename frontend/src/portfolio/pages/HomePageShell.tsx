...
export type HomePageSectionKey = "about" | "featured" | "experiences" | "projects" | "film" | "misc";
...
const HomePageShell: React.FC<{
  enhancedSections?: Partial<Record<HomePageSectionKey, HomePageSectionComponent>>;
}> = ({ enhancedSections = {} }) => {
  ...
  const contactLinks = contactLabels
    .map((label) => snapshot.profile.socialLinks.find((link) => link.label === label))
  ...
  return (
    <div className="portfolio-overhaul-page">
      ...
      <section id="about" className="homepage-shell-section" data-shell-section="about">
        {AboutEnhanced ? (
          <AboutEnhanced />
        ) : (
          ...
          <div className="about-editorial__inner">
            <div className="about-editorial__copy">
              ...
              <div className="about-editorial__body">
                <p>I build systems that make complex behavior easier to see, test, and improve.</p>
            ...
            <div className="about-editorial__visual" aria-hidden="true">
      ...
      <section id="featured" className="homepage-shell-section" data-shell-section="featured">
        {FeaturedEnhanced ? (
          <FeaturedEnhanced />
        ) : (
            ...
            <div className="featured-editorial__list" aria-label="Selected work">
              {featuredProjects.map((project) => (
                <article key={project.index} className="featured-editorial__item">
                  <div className="featured-editorial__image-wrap" aria-hidden="true" />
      ...
      <section id="experiences" className="homepage-shell-section" data-shell-section="experiences">
        {ExperiencesEnhanced ? (
          <ExperiencesEnhanced />
        ) : (
              ...
              {snapshot.experiences.map((experience) => (
                ...
                >
                  ...
                  <div className="experiences-editorial__content">
                    <p className="experiences-editorial__category">{experience.category}</p>
      ...
      <section id="projects" className="homepage-shell-section" data-shell-section="projects">
        {ProjectsEnhanced ? (
          <ProjectsEnhanced />
        ) : (
            ...
            <div className="projects-editorial__grid" role="list" aria-label="Projects">
              {projects.map((project) => (
                <article key={project.slug} className="projects-editorial__card" role="listitem">
                  <div className="projects-editorial__image-link" aria-hidden="true" />
                  <div className="projects-editorial__body">
                    ...
                    <p className="projects-editorial__tags">{project.tags.slice(0, 2).join("  •  ")}</p>
                  </div>
                </article>
              ))}
            </div>
      ...
      <section id="film" className="homepage-shell-section" data-shell-section="film">
        {FilmEnhanced ? (
          <FilmEnhanced />
        ) : (
          ...
          <div className="film-editorial__inner">
            ...
            <div className="film-editorial__main">
              <div className="film-editorial__player-shell" aria-hidden="true" />
              <div className="film-editorial__details">
                <p className="film-editorial__active-kicker">
                  {filmShell[0].year} / {filmShell[0].genre} / {filmShell[0].duration}
                </p>
                <h3 className="film-editorial__active-title">{filmShell[0].title}</h3>
                <p className="film-editorial__active-description">{filmShell[0].description}</p>
              </div>
            </div>
            <div className="film-editorial__sidebar">
              <div className="film-editorial__list" role="list" aria-label="Film portfolio list">
                {filmShell.map((film, index) => (
                  ...
                  >
                    ...
                    <span className="film-editorial__list-title">{film.title}</span>
                  </div>
                ))}
              </div>
      ...
      <section id="misc" className="homepage-shell-section" data-shell-section="misc">
        {MiscEnhanced ? (
          <MiscEnhanced />
        ) : (
