...
const AiProfile: React.FC = () => {
  ...
  const { profile, intro, education, experiences, projects, generatedAt } = snapshot;
    ...
    <main className="ai-profile-shell">
      <div className="ai-profile-frame">
        <section className="ai-profile-hero">
          ...
          <div className="ai-profile-meta-grid">
            ...
            <div className="ai-profile-meta-pill">
              ...
              <a href={intro.featuredBlog.link} target="_blank" rel="noopener noreferrer">
                {intro.featuredBlog.title}
              </a>
            </div>
            <div className="ai-profile-meta-pill">
        ...
        <GlassCard className={sectionClasses}>
          <div className="ai-profile-section-heading">
            <h2>About Me</h2>
            <p>{profile.about.introHeading}</p>
          </div>
          <p className="text-lg leading-8 text-slate-100">{profile.about.introBody}</p>
          <div className="ai-profile-about-grid">
            <div>
              <h3>Current Projects</h3>
              <ul className="ai-profile-bullet-list">
                {profile.about.currentProjects.map((item) => (
                  <li key={item}>{item}</li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="ai-profile-bullet-list">
                {profile.about.currentLearning.map((item) => (
                  <li key={item}>{item}</li>
                ))}
              </ul>
            </div>
            <div className="ai-profile-about-span">
              ...
              <ul className="ai-profile-bullet-list">
                {profile.about.interestsOutsideTechnology.map((item) => (
                  <li key={item}>{item}</li>
                ))}
              </ul>
            </div>
