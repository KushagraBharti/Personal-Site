...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary:
      "A custom Monza RL/simulation lab with real F1 telemetry-calibrated V2 physics, CUDA-scale evolutionary search, BC/SAC learned-policy training, and a 78.683s normal-start learned lap from a 300,000-candidate search.",
    description: [
