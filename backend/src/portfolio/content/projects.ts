...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary:
      "A custom Monza RL/simulation lab with F1 telemetry-calibrated V2 physics, CUDA evolutionary search, BC/SAC learned-policy training, and a 78.683s normal-start learned lap.",
    description: [
