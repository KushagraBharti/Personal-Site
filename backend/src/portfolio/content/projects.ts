...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Deployment and operations: Frontend and backend run as separate Vercel projects, backend cron routes handle calendar sync, watch renewal, and recurring-task repair, and npm is the normal install, runtime, verification, and tooling path.",
