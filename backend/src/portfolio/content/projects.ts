...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    summary:
      "A deterministic, inspectable multi-agent AI simulation where large language models play full Monopoly games under strict rules, enabling reproducible benchmarking, debugging, and research into strategic reasoning and negotiation.",
    description: [
  ...
  },
  {
    ...
    title: "Pact",
    summary:
      "A social accountability app where users create goal-based pacts, lock funds in escrow, submit proof, and let a trusted circle of validators decide the outcome.",
    description: [
