...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary:
      "A custom Monza RL/simulation lab with real F1 telemetry-calibrated V2 physics, CUDA-scale evolutionary search, BC/SAC learned-policy training, and a 77.683s normal-start learned lap from a 300,000-candidate search.",
    description: [
      ...
      "Largest speed-search result: Ran a 2000-population, 150-generation, 25k-step GPU-fused search that evaluated 300,000 controller candidates and found an 81.233s candidate under the previous V1/V2 transition milestone before the final learned-policy pipeline closed under Physics V2.",
      "V2 ES result: Under explicit Physics V2, the trusted GPU ES source path found a CPU-reranked 77.6833s lap from generation 46, candidate 724, with selected parity passing at 0 reason mismatches and 0 valid-lap mismatches.",
      ...
      "V2 dataset stats: Built a CPU-replayed V2 dataset with 16 source candidates, 50,128 transitions, 8 valid laps, a fastest source lap of 77.65s, and balanced examples across valid laps, early failures, and mid-frontier states.",
      ...
      "Final learned-policy result: Promoted a learned SAC checkpoint under explicit `physics_model=v2`, deterministic normal-start CPU MonzaSim evaluation, and `observation_profile=racing_v2`, completing a valid lap in 77.683333s against the 79.327s V2 benchmark threshold.",
      "Promotion proof: The final learned-policy promotion reached 1/1 valid lap, `lap_complete`, 4661 steps, final progress 5793.000137m, final speed 270.830kph, and a 77.683333s lap under CPU V2 evaluation.",
