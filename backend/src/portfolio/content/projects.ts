...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary:
      "A custom Monza RL/simulation lab with F1 telemetry-calibrated physics, Gymnasium/SB3 PPO infrastructure, CUDA-scale evolutionary search, and an 81.233s evolved lap from 300,000 candidates.",
    description: [
