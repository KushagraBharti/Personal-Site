import type { PortfolioEducation } from "../contracts";

export const portfolioEducation: PortfolioEducation[] = [
  {
    ...
    description:
      "Learning about data structures, algorithms, and machine learning models to develop software applications and systems. Participating in hackathons and coding competitions to enhance problem-solving skills and gain practical experience in software development.",
