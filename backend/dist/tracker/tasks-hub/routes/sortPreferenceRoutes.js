...
router.put("/:listId", requireUser_1.requireUser, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const result = yield (0, taskListService_1.upsertSortPreferenceForUser)(supabaseAdmin, req.user.id, listId, (_a = req.body) !== null && _a !== void 0 ? _a : {});
        if (!result.ok) {
