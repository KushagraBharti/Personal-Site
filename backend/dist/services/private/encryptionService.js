...
exports.decryptFromBase64 = exports.encryptToBase64 = void 0;
...
const getKey = () => {
    ...
    if (key.length !== 32) {
        throw new Error(`ENCRYPTION_KEY must be 32 bytes (base64/hex/utf8). Got ${key.length} bytes after decoding.`);
    }
    cachedKey = key;
    return key;
};
...
const decryptFromBase64 = (payloadB64) => {
