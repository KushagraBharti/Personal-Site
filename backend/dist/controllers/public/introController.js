...
const githubStatsService_1 = require("../../services/public/githubStatsService");
const getIntroData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (apiKey) {
            ...
            const weatherRes = yield axios_1.default.get("https://api.openweathermap.org/data/2.5/weather", {
